...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md bg-light shadow-sm " >
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                   <div class="fw-bold fs-4"><img style="width:50px; height:50px" src="{{ asset('logo_ist.png') }}" alt="Logo ISTD"> {{ config('app.name', 'SIGAP') }}</div> 
                </a>
        ...
        <div class="container-fluid">
            @include('include_components.flash')
            <main class="py-2">
                @yield('content')
            </main>
        </div>
